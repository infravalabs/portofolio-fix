      ...
      <div className='flex flex-col gap-4 md:gap-5'>
        <div className='flex flex-col gap-3'>
          <div className='flex px-5 md:px-16 py-1 justify-center items-center'>
            <h2 className='text-dev-black font-bold text-[24px] md:text-[42px] text-center'>
              What Can We Do for You
            </h2>
          </div>
          <div className='flex justify-center items-center px-5 md:px-28 py-1'>
            <p className='text-dev-grey font-medium text-body-sm-14 md:text-body-md-16 text-center'>
          ...
          <div className='px-2.5 py-2 flex flex-col bg-[#272C41] rounded-xl shadow-xl w-full gap-3 md:gap-3'>
            ...
            <div className='px-2.5 py-1 w-full mb-5 group'>
              <Link href={"/#contact"} className={`${bgTitleCardWhite} group-hover:bg-dev-light-grey py-1.5 rounded-lg flex justify-center items-center duration-150`}>
                <p className={`text-dev-blue group-hover:${textColorTitleCard} text-body-xs-12 font-semibold`}>Get Started Today</p>
              </Link>
            </div>
          </div>

          {/* Card 2 */}
          <div className={`px-2.5 py-2 flex flex-col ${bgTitleCardWhite} border border-gray-300 rounded-xl shadow-xl w-full gap-3 md:gap-3`}>
            <div className='flex flex-col'>
              <div className='gap-2.5 px-2.5 py-2.5 flex flex-col'>
                <div className='py-2.5 gap-0.5 flex flex-col'>
            ...
            "itemListElement": [
              {
                ...
                "itemOffered": {
                  "@type": "Service",
                  "name": "Landing Page",
                  "description": "Company Profile, UMKM, etc.",
                  "offers": {
                    "@type": "Offer",
                    "price": "25",
                    "priceCurrency": "USD",
              ...
              },
              {
                ...
                "itemOffered": {
                  ...
                  "description": "Exclusive & Interactive Wedding Website",
                  "offers": {
                    "@type": "Offer",
                    "price": "20",
                    "priceCurrency": "USD",
              ...
              },
              {
                ...
                "itemOffered": {
                  "@type": "Service",
                  "name": "Custom Website Feature",
                  "description": "Add features tailored to your needs.",
                  "offers": {
                    "@type": "Offer",
                    "price": "10",
                    "priceCurrency": "USD",
