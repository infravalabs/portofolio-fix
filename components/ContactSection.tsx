...
const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="px-5 md:px-8 lg:px-10 xl:px-50 mt-20 md:mt-16 lg:mt-25 xl:mt-25 w-full scroll-mt-32">
      <Script
        id="contact-schema"
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 gap-10 lg:gap-2 xl:gap-2">

        {/* Text / Contact Info */}
        <div className="w-full lg:w-118 xl:w-152 h-auto px-2.5 order-2 lg:order-2 xl:order-2">
          <div className="grid grid-cols-1 px-2.5 gap-y-4 md:gap-y-6 lg:gap-y-10 xl:gap-y-10 order-1 lg:order-2 xl:order-2">
            <motion.div
            ...
            >
              ...
              <h2 className="text-[24px] md:text-[32px] lg:text-[32px] xl:text-[48px] text-dev-black font-medium leading-tight tracking-normal">
        ...
        <motion.form
          ...
          className="flex flex-col px-2.5 md:px-6 lg:px-12 xl:px-12 py-2.5 order-2 lg:order-1 xl:order-1"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, amount: 0.3 }}
          transition={{ duration: 0.6 }}
